      ...
      <CardBody>
        ...
        <Row className='pt-50'>
          <Col className='mb-2' md='12' sm='12'>
            <p className='mb-50'>1 Ранг: ${data.goal}</p>
            <Progress className='avg-session-progress progress-bar-info mt-25' value='100' />
          </Col>
          <Col className='mb-2' md='12' sm='12'>
            <p className='mb-50'>2 Ранг: {data.users}$</p>
            <Progress className='avg-session-progress progress-bar-warning mt-25' value='100' />
          </Col>
          <Col className='mb-2' md='12' sm='12'>
            <p className='mb-50'>3 Ранг: {data.retention}$</p>
            <Progress className='avg-session-progress progress-bar-danger mt-25' value='100' />
          </Col>
          <Col className='mb-2' md='12' sm='12'>
            <p className='mb-50'>4 Ранг: {data.duration}$</p>
            <Progress className='avg-session-progress mt-25' value='30' />
          </Col>
          <Col className='mb-2' md='12' sm='12'>
            <p className='mb-50'>5 Ранг: {data.fixation}$</p>
